...
class AlbumController < ApplicationController
  ...
  def get_common_albums
    albums = [] 
    albums.append({name: '艾薇儿的歌', author: 'Avril Lavigne', type: 'Common',  id: 8, image: 'images/default.png',
                   count: 50, listenCount: '1000万'}) 
    albums.append({name: '袁腾飞讲历史精选集', author: '袁腾飞', type: 'Common',id: 0, image: 'images/yuantengfei.jpg',
                   count: 32, listenCount: '10万'}) 
    albums.append({name: '久石让の唯美纯音乐', author: '久石让', type: 'Common', id: 1, image: 'images/default.png', 
